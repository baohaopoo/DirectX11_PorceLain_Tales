...
UI::UI(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
...
void UI::Tick(_double TimeDelta)
{
...
void UI::LateTick(_double TimeDelta)
{
...
UI* UI::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	UI* pInstance = new UI(pDeviceOut, pDeviceContextOut);
