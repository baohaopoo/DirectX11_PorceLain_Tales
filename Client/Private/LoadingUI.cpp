...
LoadingUI::LoadingUI(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
...
void LoadingUI::Tick(_double TimeDelta)
{
...
void LoadingUI::LateTick(_double TimeDelta)
{
...
HRESULT LoadingUI::SetUp_Components()
{
    ...
    /* For.Com_Texture */
    if (FAILED(__super::SetUp_Components(TEXT("Com_Texture"), LEVEL_LOADING, TEXT("Prototype_Component_Texture_LoadingUI"), (CComponent**)&m_pTextureCom)))
        return E_FAIL;

    return S_OK;
}

LoadingUI* LoadingUI::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
    LoadingUI* pInstance = new LoadingUI(pDeviceOut, pDeviceContextOut);
